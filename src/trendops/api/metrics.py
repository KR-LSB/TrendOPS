...
PIPELINE_ITEMS_PROCESSED = Counter(
    'trendops_items_processed_total',
...
ARTICLES_COLLECTED = Counter(
    'trendops_articles_collected_total',
    'Total articles collected',
    ['source']
)

ARTICLES_DEDUPLICATED = Counter(
    'trendops_articles_deduplicated_total',
    'Total articles removed by deduplication'
)
...
ANALYSIS_REQUESTS = Counter(
    'trendops_analysis_requests_total',
    'Total analysis requests',
    ['model', 'status']
)

GUARDRAIL_CHECKS = Counter(
    'trendops_guardrail_checks_total',
...
ACTIVE_KEYWORDS = Gauge(
    'trendops_active_keywords',
    'Number of active keywords being tracked'
)
