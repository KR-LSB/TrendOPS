...
class ArticleRepository(BaseRepository[Article]):
    ...
    async def get_by_keyword(self, keyword_id: UUID | str, limit: int = 100) -> list[Article]:
...
class AnalysisRepository(BaseRepository[Analysis]):
    ...
    async def get_by_keyword(self, keyword_id: UUID | str, limit: int = 10) -> list[Analysis]:
...
class PublicationRepository(BaseRepository[Publication]):
    ...
    async def get_by_platform(self, platform: str, limit: int = 100) -> list[Publication]:
    ...
    async def get_by_status(self, status: str, limit: int = 100) -> list[Publication]:
